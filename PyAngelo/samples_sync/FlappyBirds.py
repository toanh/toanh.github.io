...
# collision!
if player.overlaps(pipe_top):
    player.x = 0
    player.y = 200
    score = 0
    pipe_top.x = randint(550, 600)
if player.overlaps(pipe_ground):
    player.x = 0
    player.y = 200
    score = 0
    pipe_ground.x = randint(550, 600)

if player.y < 0:
    graphics.clear()
    pipe_top.x = 600
    pipe_ground.x = 600
    graphics.drawText("THE END", 180, 200, fontSize=20)
